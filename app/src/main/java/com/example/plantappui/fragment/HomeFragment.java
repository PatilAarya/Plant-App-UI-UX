...
public class HomeFragment extends Fragment {
   ...
   private GroupAdapter adapter;
    ...
    private void initPlantData() {
        ...
        recommendList.add(new Plant("Lily", "Singapore","$300",R.drawable.image_1));
        recommendList.add(new Plant("Lily", "Singapore","$300",R.drawable.image_2));
        recommendList.add(new Plant("Lily", "Singapore","$300",R.drawable.image_3));
        featuredList.add(new Plant("Lily", "Singapore","$300",R.drawable.bottom_img_1));
    }
